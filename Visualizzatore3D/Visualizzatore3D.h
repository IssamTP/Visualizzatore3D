...
#include "resource.h"
    ...
    #pragma comment(lib, "E:\\Sviluppo\\Visualizzatore3D\\x64\\Debug\\OgreBites_d.lib")
    #pragma comment(lib, "E:\\Sviluppo\\Visualizzatore3D\\x64\\Debug\\OgreRTShaderSystem_d.lib")
#else
	#pragma comment(lib,"E:\\Sviluppo\\OGRE\\lib\\OgreMain.lib")
    #pragma comment(lib, "E:\\Sviluppo\\OGRE\\lib\\OgreBites.lib")
    #pragma comment(lib, "E:\\Sviluppo\\OGRE\\lib\\OgreRTShaderSystem.lib")
#endif

class OgreApplication
{
    const Ogre::String C_RENDERER_NAME = "Direct3D11 Rendering Subsystem";
protected:
	Ogre::FileSystemLayer* m_FSLayer;
	Ogre::Log* m_Log;
...
//        }
    ...
    void InizializzaShader()
    {
        if (Ogre::RTShader::ShaderGenerator::initialize())
        {
            ...
            if (!m_MaterialMgrListener && false)
            {
       ...
       /* while (it != renderers.end())
        {
            ...
            if (renderer->getName().compare(C_RENDERER_NAME) == 0)
            {
